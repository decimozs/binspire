...
/**
 * DialogOverlay — accepts optional `opacity` prop (default = 50)
 */
    ...
    <DialogPrimitive.Overlay
      ...
      className={cn(
        `data-[state=open]:animate-in data-[state=closed]:animate-out 
         ...
         fixed inset-0 z-50 bg-black/${opacity}`,
        className,
      )}
      {...props}
    />
...
/**
 * DialogContent — accepts optional `overlayOpacity` prop to control overlay
 */
