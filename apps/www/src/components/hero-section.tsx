...
export default function HeroSection() {
  const words = ["Sustainability", "Regeneration"];
      ...
      <main className="overflow-hidden">
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                >
                  Transforming Waste Into Data-Driven <br />
                ...
                >
                  Empowering cities and businesses to manage waste intelligently
                  through real-time insights and smart monitoring.
                </TextEffect>
        ...
        <section className="bg-background pb-16 pt-16 md:pb-32">
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs mx-auto mt-12 max-w-2xl flex flex-row items-center justify-center gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
              <div className="flex">
                <img
                  className="mx-auto h-20 w-fit mt-2"
                  src="/plp-logo.png"
                  alt="PLP Logo"
                  height="50"
                  width="auto"
